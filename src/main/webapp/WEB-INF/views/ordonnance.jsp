...
<div style="margin-bottom:0.5%;margin-left:1.6%;margin-top:1%;font-size: 23px;" ><span class="glyphicon glyphicon-user"></span> Medecin</div>
	...
	<div id="chemin">
		...
		<a  href="DossierPatient?idPat=${idPat}"><span class="glyphicon glyphicon-folder-open"></span> Dossier</a><span class="glyphicon glyphicon-menu-right"></span>
		<span class="glyphicon glyphicon-file"></span>Formulaire Ordonnance
	</div>
	
	<div id="milieu">
		<f:form modelAttribute="ordonnance" action="saveOrdonnance" 
	     ...
	     <div style="margin-left:15%;width: 70%;margin-top: 20px;border:2px solid;border-bottom-color: black;border-right-color: #f1f1f1;border-left-color: #f3f3f3;border-top-color: black" class="form-group">
			...
			<label style="margin-left:15px; margin-top:-5px" for="dateord">Date</label>
			<f:input class="form-control" id="datepicker" path="date"/>
			<f:errors path="date" cssClass="errors"></f:errors>
			
			<label style="margin-left:15px; margin-top:-5px" for="medocsord">Listes des Medicaments</label>
			<f:textarea class="form-control" id="medocsord" path="medicament" placeholder="medicament1,medicament2,medicament3,..."/>
			<f:errors path="medicament" cssClass="errors"></f:errors>
