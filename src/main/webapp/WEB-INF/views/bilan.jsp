...
<div style="margin-bottom:0.5%;margin-left:1.6%;margin-top:1%;font-size: 23px;" ><span class="glyphicon glyphicon-user"></span> Medecin</div>
	...
	<div id="chemin">
		...
		<span class="glyphicon glyphicon-menu-right"></span><span class="glyphicon glyphicon-file"></span> Formulaire bilan
	</div>
	<div id="milieu">
		<f:form modelAttribute="bilan" action="saveBilan" 
	     ...
	     <div style="margin-left:15%;width: 70%;margin-top: 20px;border:2px solid;border-bottom-color: black;border-right-color: #f1f1f1;border-left-color: #f3f3f3;border-top-color: black" class="form-group">
				...
				<label style="margin-left:15px; margin-top:-5px" for="datebil">Date de creation</label>
				<f:input class="form-control" id="datepicker" type="text" path="date"/>
				<f:errors path="date" cssClass="errors"></f:errors>
				
				<label style="margin-left:15px; margin-top:-5px" for="libellebil">Libelle</label>
				<f:input class="form-control" id="libellebil" type="text" path="libelle"/>
				<f:errors path="libelle" cssClass="errors"></f:errors>
				
				<label style="margin-left:15px; margin-top:-5px" for="descriptiobil">Description</label>
				<f:textarea class="form-control" id="descriptionbil" rows="3" path="description"/>
